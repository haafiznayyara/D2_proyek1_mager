...
avatar_icon = os.path.join(BASE_DIR, "../../assets/avatar_outline.png")
lock_icon   = os.path.join(BASE_DIR, "../../assets/lock_outline.png")
...
class LoginWindow(QWidget):
    ...
    def _do_login(self):
        from pages.auth.auth_logic import login_user
...
class RegisterWindow(QWidget):
    ...
    def _do_register(self):
        from pages.auth.auth_logic import register_user
        username = self.inp_user.text().strip()
        password = self.inp_pass.text()
